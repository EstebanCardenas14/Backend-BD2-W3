...
const validateUser = async (id_rol, id_documento,username, num_doc, telefono, correo, req = request, res = response) => {
    try {
        ...
        return new Promise(async(resolve, reject) => {
            ...
            //validate the rol of the user
            if(rol.rowCount === 0){
                return reject('El rol no existe');
            }
